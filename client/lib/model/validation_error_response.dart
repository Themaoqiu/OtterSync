...
class ValidationErrorResponse {
  ...
  @override
  String toString() => 'ValidationErrorResponse[detail=$detail]';
  ...
  static ValidationErrorResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ValidationErrorResponse(
        detail: ValidationErrorDetail.listFromJson(json[r'detail']),
      );
    }
    return null;
  }

  static List<ValidationErrorResponse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ValidationErrorResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ValidationErrorResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ValidationErrorResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
