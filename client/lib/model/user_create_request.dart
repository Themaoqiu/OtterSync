...
class UserCreateRequest {
  ...
  @override
  String toString() => 'UserCreateRequest[name=$name, email=$email]';
  ...
  static UserCreateRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'name'), 'Required key "UserCreateRequest[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "UserCreateRequest[name]" has a null value in JSON.');
        assert(json.containsKey(r'email'), 'Required key "UserCreateRequest[email]" is missing from JSON.');
        assert(json[r'email'] != null, 'Required key "UserCreateRequest[email]" has a null value in JSON.');
        return true;
      }());
